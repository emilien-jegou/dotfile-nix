...
- Browser: :fox_face: Firefox developer edition
...
```bash
git clone https://github.com/emilien-jegou/dotfiles-nix ~/.config/nixos && cd ~/.config/nixos
```
...
## Special thanks to notusknot for [his very clean dotfile!](https://github.com/notusknot/dotfiles-nix)
