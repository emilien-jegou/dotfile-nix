...
hi SignColumn   term=NONE cterm=NONE ctermfg=NONE ctermbg=16
hi Comment      term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi Constant     term=NONE cterm=bold ctermfg=10   ctermbg=NONE
hi Cursor       term=NONE cterm=bold ctermfg=11   ctermbg=NONE
hi CursorLine   term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
hi DiffAdd      term=NONE cterm=bold ctermfg=10   ctermbg=NONE
hi DiffChange   term=NONE cterm=bold ctermfg=11   ctermbg=NONE
hi DiffDelete   term=NONE cterm=bold ctermfg=9    ctermbg=NONE

hi FoldColumn   term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi Folded       term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi Function     term=NONE cterm=bold ctermfg=15   ctermbg=NONE
hi Identifier   term=NONE cterm=bold ctermfg=9    ctermbg=NONE
hi IncSearch    term=NONE cterm=bold ctermfg=13   ctermbg=5
hi NonText      term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi Normal       term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
hi Pmenu        term=NONE cterm=NONE ctermfg=0    ctermbg=7
hi PreProc      term=NONE cterm=bold ctermfg=11   ctermbg=NONE
hi Search       term=NONE cterm=bold ctermfg=15   ctermbg=5
hi Special      term=NONE cterm=bold ctermfg=10   ctermbg=NONE
hi SpecialKey   term=NONE cterm=NONE ctermfg=2    ctermbg=NONE
hi Statement    term=NONE cterm=bold ctermfg=15   ctermbg=NONE
hi StatusLine   term=NONE cterm=bold ctermfg=8    ctermbg=NONE
" highlight StatusLineNC term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi String       term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
hi TabLineSel   term=NONE cterm=bold ctermfg=15    ctermbg=NONE
hi Todo         term=NONE cterm=bold ctermfg=15    ctermbg=1
hi Type         term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
hi VertSplit    term=NONE cterm=bold ctermfg=8    ctermbg=NONE
hi Visual       term=NONE cterm=bold ctermfg=15    ctermbg=3
