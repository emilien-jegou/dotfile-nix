...
let s:style = get(g:, 'weynotcolor', 'dark')
let g:colors_name = "weynot"
"}}}
...
let s:palette.bg        = {'dark': "#0b0b0b",  'light': "#FAFAFA",  'mirage': "#212733"}

let s:palette.comment   = {'dark': "#454159",  'light': "#ABB0B6",  'mirage': "#5C6773"}
let s:palette.markup    = {'dark': "#A600C1",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#76b639",  'light': "#A37ACC",  'mirage': "#D4BFFF"}
let s:palette.operator  = {'dark': "#000" ,  'light': "#E7C547",  'mirage': "#80D4FF"}
let s:palette.tag       = {'dark': "#ff6702",  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#e1a126",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#d8175c",  'light': "#86B300",  'mirage': "#BBE67E"}
let s:palette.function  = {'dark': "#000",  'light': "#F29718",  'mirage': "#FFD57F"}
let s:palette.special   = {'dark': "#76b639",  'light': "#E6B673",  'mirage': "#FFC44C"}
let s:palette.keyword   = {'dark': "#000",  'light': "#FF7733",  'mirage': "#FFAE57"}
let s:palette.text   = {'dark': "#000",  'light': "#FF7733",  'mirage': "#FFAE57"}

let s:palette.error     = {'dark': "#FF3333",  'light': "#FF3333",  'mirage': "#FF3333"}
let s:palette.accent    = {'dark': "#F29718",  'light': "#FF6A00",  'mirage': "#FFCC66"}
let s:palette.panel     = s:palette.bg
...
exe "hi! DiffAdd"       .s:fg_string      .s:bg_panel       .s:fmt_bold
exe "hi! DiffChange"    .s:fg_tag         .s:bg_panel       .s:fmt_bold
exe "hi! DiffText"      .s:fg_fg          .s:bg_panel       .s:fmt_bold
exe "hi! ErrorMsg"      .s:fg_fg          .s:bg_error       .s:fmt_stnd
exe "hi! VertSplit"     .s:fg_bg          .s:bg_none        .s:fmt_bold
exe "hi! Folded"        .s:fg_fg_idle     .s:bg_panel       .s:fmt_bold
exe "hi! FoldColumn"    .s:fg_none        .s:bg_panel       .s:fmt_bold
...
exe "hi! NonText"       .s:fg_guide       .s:bg_none        .s:fmt_bold
exe "hi! Pmenu"         .s:fg_fg          .s:bg_selection   .s:fmt_none
exe "hi! PmenuSel"      .s:fg_fg          .s:bg_selection   .s:fmt_revr
"   PmenuSbar"
"   PmenuThumb"
exe "hi! Question"      .s:fg_string      .s:bg_none        .s:fmt_none
exe "hi! Search"        .s:fg_bg          .s:bg_constant    .s:fmt_bold
exe "hi! SpecialKey"    .s:fg_selection   .s:bg_none        .s:fmt_bold
exe "hi! SpellCap"      .s:fg_text         .s:bg_none        .s:fmt_undr
exe "hi! SpellLocal"    .s:fg_keyword     .s:bg_none        .s:fmt_undr
exe "hi! SpellBad"      .s:fg_error       .s:bg_none        .s:fmt_undr
exe "hi! SpellRare"     .s:fg_regexp      .s:bg_none        .s:fmt_undr
exe "hi! StatusLine"    .s:fg_fg          .s:bg_panel       .s:fmt_bold
exe "hi! StatusLineNC"  .s:fg_fg_idle     .s:bg_panel       .s:fmt_bold
...
exe "hi! Visual"        .s:fg_none        .s:bg_selection   .s:fmt_bold
"   VisualNos"
...
" ----------------------------------------------------------------------------
exe "hi! Comment"         .s:fg_comment   .s:bg_none        .s:fmt_bold

exe "hi! Constant"        .s:fg_constant  .s:bg_none        .s:fmt_bold
...
exe "hi! Identifier"      .s:fg_text       .s:bg_none        .s:fmt_bold
...
exe "hi! Special"         .s:fg_special   .s:bg_none        .s:fmt_bold
"   SpecialChar"
"   Tag"
"   Delimiter"
"   SpecialComment"
"   Debug"
"
exe "hi! Underlined"      .s:fg_text       .s:bg_none        .s:fmt_none
